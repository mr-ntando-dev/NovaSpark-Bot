/**
 * NovaSpark Bot v10.0 — NEON-MD Style Menu
...
module.exports = {
  ...
  execute: async ({ sock, msg, from, sender, args, reply }) => {
    ...
    const menu = [
      ...
      c('agent <task>  🆕'),
      c('persona <name>  /  memory on/off  🆕'),
      c('autochat on/off'),
      c('multilang on/off  🆕'),
      c('vision  /  docanalyze  /  imggen <prompt>  🆕'),
      c('voicechat on/off  /  codex <code>  🆕'),
      c('aieyes on/off  /  aieyes sensitivity 1-5  🆕👁️'),
      c('imagine <prompt>'),
      c('imagine2 <prompt>'),
      c('remini'),
      c('removebg'),
      ...
      c('studytips <subject>'),
      c('math <problem>'),
      c('math paper <full question paper>  🆕'),
      c('translate <lang> <text>'),
      c('pdf'),
      c('myplan  🆕  — study planner'),
      c('nasa  🆕  — NASA picture of the day'),
      SEP,

      // ── Games ────────────────────────────────────────────────────────
      sec('🎮', 'G A M E S   &   C H A L L E N G E S'),
      c('wordle'),
      c('trivia  /  hangman  /  scramble'),
      ...
      c('ytmp4 <query/url>'),
      c('ytshorts <url>  🆕'),
      c('yt <query>  🆕  — YouTube search'),
      c('tiktok  /  instagram  /  facebook  /  pinterest'),
      c('twitter <url>  /  threads <url>  🆕'),
      c('reddit <url>  /  snack <url>  /  likee <url>  🆕'),
      c('soundcloud <url>  /  capcut <url>  🆕'),
      c('spotify <query>'),
      c('gdrive <url>  /  mediafire <url>  /  apk <url>  🆕'),
      c('alldl <url>  🆕  — universal downloader'),
      SEP,
      ...
      c('remini  /  removebg'),
      c('youtube <query>  /  tiktok <query>  🆕  — media search'),
      SEP,

      // ── Group ────────────────────────────────────────────────────────
      sec('🛡️', 'G R O U P   M A N A G E M E N T'),
      c('kick  /  promote  /  demote  /  ban  /  unban'),
      c('warn  /  warn2  /  warns  /  clearwarn  /  listwarn  /  setwarnlimit  🆕'),
      c('tagall  /  hidetag  /  tagadmins  /  delete'),
      c('mute  /  unmute  /  mutelist  🆕'),
      c('grouplink  /  resetlink  /  welcome  /  goodbye'),
      c('grouprules  /  addrule  /  clearrules  🆕'),
      c('setrules <rules>  /  rules'),
      c('nightmode  /  vip  /  ghost on/off'),
      c('aiwelcome on/off  🆕  — AI-powered welcome'),
      c('antilink  /  antitoxic  /  antiflood  /  antiraid'),
      c('antiword  /  antifwd  /  antispam  /  antibadword  /  antifake  🆕'),
      c('antimedia on/off  🆕'),
      c('autokick  /  autoreact  /  autoreply  /  autonudge'),
      c('autoreplykw add/list/remove  🆕  — keyword auto-reply'),
      c('groupinfo  /  groupstats  /  membercount  /  topmembers'),
      c('groupbackup  /  leaderboard  🆕'),
      c('slowmode on 30  /  slowmode off'),
      c('smartmod on/off  🆕  — smart auto-moderation'),
      c('pin  /  pins  /  unpin <n>  /  unpinall  🆕'),
      c('xp  /  xp leaderboard'),
      ...
      c('autopm on/off  🆕  — auto DM on join'),
      c('autoreport on/off  🆕'),
      c('autoprotect on/off  🆕'),
      c('autostatusreact on/off  🆕  — react to statuses'),
      c('autostatusreact emoji 🔥  🆕'),
      c('autobio on/off  🆕  — TBJ quotes as bio'),
      c('autobio interval <min>  /  autobio now  🆕'),
      c('waprotect on/off/status  🔒 Enhanced v10'),
      c('waprotect scam/flood/links on/off  🆕'),
      c('waprotect block/warn on/off  🆕'),
      c('waprotect keyword add/remove/list  🆕'),
      c('waprotect whitelist add/remove/list  🆕'),
      c('waprotect stats  /  resetstats  🆕'),
      c('pmblocker'),
      ...
      c('shutdown  /  restart  /  botstats  /  alive'),
      c('eval <code>'),
      c('broadcast  /  announce  /  dmowner  /  globalannounce  🆕'),
      c('dm @user <msg>  🆕  — DM a specific user'),
      c('setpremium add/rm/list'),
      c('ban  /  unban  /  banlist  /  cleardb'),
      c('setprefix  /  resetprefix  /  setprofile  /  setnick  🆕'),
      c('listgroups  /  joingroup  /  leavegroup'),
      c('ownerlist  /  addowner  /  removeowner'),
      c('ownermode on/off  🆕'),
      c('maintenance on/off'),
      c('ratelimit set/status/reset  🆕'),
      c('analytics  🆕  — bot usage stats'),
      c('webhook set/test/remove  🆕'),
      c('plugin list/enable/disable  🆕'),
