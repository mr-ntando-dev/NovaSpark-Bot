...
lines = [
    ...
    "    const plan   = isPrem ? 'D83dDcb8 Premium Member' : 'D83cDd93 Free User';",
...
path = '/home/ninja/novaspark/commands/free/menu.js'
with open(path, 'w', encoding='utf-8') as f:
    f.write('\n'.join(lines) + '\n')

print(f"Written: {os.path.getsize(path)} bytes, {len(lines)} lines")
